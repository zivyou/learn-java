...
public class DummyServiceImpl implements DummyService{
    @Override
    public void commit(StateMachineEngine stateMachineEngine) {
        ...
        StateMachineInstance inst = stateMachineEngine.startWithBusinessKey("reduceInventoryAndBalance",
    ...
    @Override
    public void compensate(StateMachineEngine stateMachineEngine) {
